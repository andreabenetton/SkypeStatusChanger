...
namespace SkypeStatusChanger 
{
                                    ...
                                    
    {
        ...
        /// </summary>
        private const string CHANNEL_NAME_SUFFIX = "SingeInstanceIPCChannel";

        /// <summary>
        /// Remote service name.
        /// </summary>
        private const string REMOTE_SERVICE_NAME = "SingleInstanceApplicationService";

        /// <summary>
        /// IPC protocol used (string).
        /// </summary>
        private const string IPC_PROTOCOL = "ipc://";
        ...
        public static bool InitializeAsFirstInstance( string uniqueName )
        {
            ...
            string channelName = String.Concat(applicationIdentifier, DELIMITER, CHANNEL_NAME_SUFFIX);
        ...
        private static void CreateRemoteService(string channelName)
        {
            ...
            RemotingServices.Marshal(remoteService, REMOTE_SERVICE_NAME);
        }
        ...
        private static void SignalFirstInstance(string channelName, IList<string> args)
        {
            ...
            string remotingServiceUrl = IPC_PROTOCOL + channelName + "/" + REMOTE_SERVICE_NAME;
